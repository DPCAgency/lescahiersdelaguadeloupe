...
## Purpose
Populates the homepage_sections table with the 13 sections that make up the
homepage of Les Cahiers de la Guadeloupe, matching the validated Phase 2 layout.
Each section's settings_json contains the editorial content from the validated
local data files.

## Tables Populated
- homepage_sections (13 rows)

## Idempotency
Uses ON CONFLICT DO NOTHING — safe to re-run.
*/

INSERT INTO homepage_sections (type, position, is_visible, title, settings_json) VALUES
  ('hero', 1, true, 'Grande Une', '{
    "label": "Enquête",
    "title": "Qui gouverne réellement Le Gosier ?",
    "issueNumber": "N°02",
    "issueDate": "Août 2026",
    "excerpt": "Ce cahier ne désigne pas de coupables. Il pose une question : qui exerce réellement l''influence dans la fabrication de la décision publique au Gosier ?",
  ...
  ('who_decides', 2, true, 'Qui décide ?', '{
    "intro": "Cette enquête cherche à comprendre comment se construit réellement la décision publique et où se situent les différents centres d''influence.",
    "actors": [
  ...
  ('editorial_intro', 3, true, 'Introduction éditoriale', '{
    "label": "Gouvernance locale",
    "title": "Une question de gouvernance",
    "question": "Les différentes fonctions, relations et intérêts sont-ils demeurés suffisamment séparés pour garantir l''impartialité de la décision publique ?"
  }'),
  ('dossier', 4, true, 'Le dossier', '{
    "title": "Le dossier",
  ...
  ('key_figures', 5, true, 'Chiffres clés', '{
    "eyebrow": "Repères",
  ...
  ('central_question', 7, true, 'Question centrale', '{
    "question": "Les différentes fonctions, relations et intérêts sont-ils demeurés suffisamment séparés pour garantir l''impartialité de la décision publique ?"
  }'),
  ('latest_investigations', 8, true, 'Dernières enquêtes', '{
    "title": "Dernières enquêtes",
    "articles": [
      { "slug": "qui-gouverne-reellement-le-gosier", "rubric": "politique-institutions", "format": "enquete", "title": "Qui gouverne réellement Le Gosier ?", "excerpt": "Maire, élus, cabinet, administration, acteurs économiques : où s''exerce réellement l''influence dans la fabrication de la décision publique ?", "date": "15 août 2026", "author": "La rédaction", "readingTime": 35, "chapters": 7, "image": "https://images.pexels.com/photos/2120356/pexels-photo-2120356.jpeg?auto=compress&cs=tinysrgb&w=1280", "imageAlt": "Vue côtière de la Guadeloupe", "featured": true, "accessType": "free" },
      { "slug": "gouvernance-municipale-gosier", "rubric": "politique-institutions", "format": "analyse", "title": "Comprendre les rôles, les fonctions et les frontières", "excerpt": "Que prévoit le code général des collectivités ? Comment se répartissent les compétences entre maire, conseil municipal et cabinet ?", "date": "15 août 2026", "author": "La rédaction", "readingTime": 12, "image": "https://images.pexels.com/photos/25637102/pexels-photo-25637102.jpeg?auto=compress&cs=tinysrgb&w=900", "imageAlt": "Vue aérienne d''une côte antillaise", "accessType": "free" },
      { "slug": "chronologie-faits-gosier", "rubric": "politique-institutions", "format": "chronologie", "title": "Les étapes clés reconstituées", "excerpt": "Une chronologie documentée des faits, décisions et événements qui ont marqué la gouvernance du Gosier.", "date": "15 août 2026", "author": "La rédaction", "readingTime": 8, "accessType": "free" }
    ]
  }'),
  ('analysis', 9, true, 'Analyses & décryptages', '{
    "title": "Analyses & décryptages",
    "articles": [
      { "slug": "structures-et-interets", "rubric": "economie", "format": "decryptage", "title": "Structures et intérêts : entreprises, associations, fonctions", "excerpt": "Croisement des mandats, des activités professionnelles et des liens avec la décision publique.", "date": "15 août 2026", "author": "La rédaction", "readingTime": 15, "accessType": "free" },
      { "slug": "gouvernance-municipale-gosier", "rubric": "politique-institutions", "format": "analyse", "title": "Comprendre les rôles, les fonctions et les frontières", "excerpt": "Que prévoit le code général des collectivités ? Comment se répartissent les compétences entre maire, conseil municipal et cabinet ?", "date": "15 août 2026", "author": "La rédaction", "readingTime": 12, "accessType": "free" },
      { "slug": "chronologie-faits-gosier", "rubric": "politique-institutions", "format": "chronologie", "title": "Les étapes clés reconstituées", "excerpt": "Une chronologie documentée des faits, décisions et événements qui ont marqué la gouvernance du Gosier.", "date": "15 août 2026", "author": "La rédaction", "readingTime": 8, "accessType": "free" }
    ]
  }'),
  ('territories', 10, true, 'Territoires', '{
  ...
  ('latest_issue', 11, true, 'Dernier Cahier', '{
    "issueSlug": "numero-02"
  }'),
  ('method', 12, true, 'Notre méthode', '{
    "title": "Notre méthode",
    "steps": [
